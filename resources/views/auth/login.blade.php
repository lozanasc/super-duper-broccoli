    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <a href="{{ url('auth/google') }}" class="flex font-sans ml-2 bg-gray-800 text-white py-1 px-4 rounded-lg">
                    Sign in with
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" class="h-6 w-6 p-1 bg-white ml-2 rounded-full my-auto">
