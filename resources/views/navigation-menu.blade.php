                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @switch(auth()->user()->role)
                        @case("User")
                            ...
                            @break
                        @case("Admin")
                            <x-jet-nav-link href="{{ route('view_users') }}" :active="request()->routeIs('view_users')">
                                Manage Users
                            </x-jet-nav-link>
                            <x-jet-nav-link href="{{ route('appointments') }}" :active="request()->routeIs('appointments')">
                                Appointments
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-red-600 font-bold">
                                        @if (auth()->user()->role === "User")
                                            {{ count(App\Models\Notification::where('user', auth()->user()->name)->where('role', auth()->user()->role)->get()) }}
                                        @else
                                            {{ count(App\Models\Notification::where('role', auth()->user()->role)->get()) }}
                                        @endif
                                    </span>
                                </div>
                            </x-jet-dropdown-link>
