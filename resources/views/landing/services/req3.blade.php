...
@section('root')
  <section class="text-gray-600 body-font">
    <p class="sm:text-lg text-base font-semibold text-center title-font mt-12 mb-0 text-gray-900">
      REQUEST FOR CERTIFIED TRUE COPIES OF TAX DECLARATION AND CERTIFICATION
    </p>
    <div class="container px-5 py-6 mx-auto flex flex-wrap">
      <div>
        <p class="sm:text-lg text-base font-light my-2 text-gray-900">Service Fee: ₱100/Certificate or Copy</p>
      </div>
        ...
        <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
          ...
          <div class="flex relative pb-12">
            ...
            <div class="flex-grow pl-4">
              ...
              <p class="leading-relaxed">PIN (If none, proceed to Tax Mapping Division for verification).</p>
            </div>
          </div>
          <div class="flex relative pb-12">
            <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
